# This file comes from here https://github.com/harvardinformatics/mafTools/blob/docker/Dockerfile
# and is only slightly modified
...
COPY --from=builder /mafTools/mafComparator/comparatorSummarizer.py /etc
RUN ls
...
# To run
# docker run --name container_name  -v $(pwd): /workdir images_name
